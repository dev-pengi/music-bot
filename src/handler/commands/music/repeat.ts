...
export default {
    name: "repeat",
    description: "set the repeat mode for the current song",
    async run(message: Message, args: string[], client: Client): Promise<void> {
        try {
            ...
            const replyContent = status ? `the repeat mode for the song has been enabled` : `the repeat mode for the song has been disabled`;
